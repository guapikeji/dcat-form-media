    ...
    var LakeFormMedia = {
        init: function() {
            ...
            this.onEvent("mouseenter", ".js-dragsort", function() {
                var showRowCont = $(this).parents(
                    ".lake-form-media-img-show-row"
                );
                ...
                showRowCont.dragsort({
                    ...
                    placeHolderTemplate: $(
                        '<div class="lake-form-media-preview-item" />'
                    ),
                    scrollSpeed: 15
                });
            ...
            this.onEvent(
                "click",
                ".lake-form-media-img-show-item-delete",
                function() {
                    var $this = $(this);
                    ...
                    var mediaShowCont = mediaCont.find(
                        ".lake-form-media-img-show"
                    );
                    ...
                    layer.confirm(
                        ...
                        function(index) {
                            ...
                            if (multiplechoice != 1 && limit > 1) {
                                ...
                                mediaCont
                                    .find(
                                        '.lake-form-media-preview-item[data-src="' +
                                            itemurl +
                                            '"]'
                                    )
                                    .remove();
            ...
            this.onEvent("click", ".lake-form-media-btn-file", function(event) {
                ...
                var mediaModalPageCont = mediaModalCont.find(
                    ".lake-form-media-modal-page"
                );
                mediaModalPageCont.data("current-page", 1);

                var mediaModalDirInput = mediaModalCont.find(
                    ".lake-form-media-dir-input"
                );
                mediaModalDirInput.val(keywords);

                var mediaModalNavOlCont = mediaModalCont.find(
                    ".lake-form-media-nav-ol"
                );
                mediaModalNavOlCont.data("current-path", path);

                if (uploadUrl.length <= 0) {
                    mediaModalCont
                        .find(".lake-form-media-upload-label")
                        .addClass("hidden");
                }
                if (createFolderUrl.length <= 0) {
                    mediaModalCont
                        .find(".lake-form-media-create-folder-label")
                        .addClass("hidden");
                }

                mediaModalCont.find(".modal-title").text(
                    thiz.lang("select_type", {
                        title: title
                    })
                );
            ...
            this.onEvent(
                "dblclick",
                ".lake-form-media-row-col .row-title",
                function() {
                    var data = $(this).text();
            ...
            this.onEvent(
                "click",
                ".lake-form-media-modal-prev-page",
                function() {
                    var mediaModalCont = $(this).parents(
            ...
            this.onEvent(
                "click",
                ".lake-form-media-modal-next-page",
                function() {
                    var mediaModalCont = $(this).parents(
                        ".lake-form-media-modal"
                    );
            ...
            this.onEvent("click", ".lake-form-media-submit", function(res) {
                ...
                if (type == "blend") {
                    select_true_list = mediaModalCont.find(
                        ".lake-form-media-selected"
                    );
                } else {
                    select_true_list = mediaModalCont.find(
                        '.lake-form-media-selected[data-type="' + type + '"]'
                    );
                }
            ...
            this.onEvent("click", ".lake-form-media-field-item-op", function() {
                ...
                var noNeedSelectArr = [];
                if (type != "blend") {
                    var imgItem = mediaModalCont.find(
                        '.lake-form-media-field-item[data-type="' +
                            itemType +
                            '"]'
                    );
                } else {
                    var imgItem = mediaModalCont.find(
                        ".lake-form-media-field-item"
                    );
                }
                ...
                var selectedItem = mediaModalCont.find(
                    ".lake-form-media-selected"
                );
                var selectNum =
                    nowNumArr.length -
                    noNeedSelectArr.length +
                    selectedItem.length;
            ...
            this.onEvent(
                "click",
                ".lake-form-media-img-show-item-preview",
                function() {
                    ...
                    layer.open({
                        ...
                        content:
                            '<div style="display: flex;align-items: center;justify-content: center;text-align: justify;height: 100%;">' +
                            preview +
                            "</div>"
                    });
                }
        ...
        getdata: function(name, path = "/", options = []) {
            ...
            var mediaModalTableCont = mediaModalCont.find(
                ".lake-form-media-body-table"
            );
            var mediaModalNavOlCont = mediaModalCont.find(
                ".lake-form-media-nav-ol"
            );
            ...
            var mediaModalOrderCont = mediaModalCont.find(
                ".lake-form-media-modal-order"
            );
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (JSON.stringify(list) != "[]") {
                        for (var i in list) {
                            if (list[i]["isDir"]) {
                                ...
                                htmltemp +=
                                    '<div class="thumbnail lake-form-media-field-item lake-form-media-dir-op" data-type="' +
                                    list[i]["type"] +
                                    '" data-path="/' +
                                    list[i]["name"] +
                                    '" title="' +
                                ...
                                htmltemp +=
                                    '<a href="javascript:;" class="file-name">' +
                                    list[i]["namesmall"] +
                                    "</a>";
                                htmltemp += "</div>";
                                htmltemp += "</div>";
                                ...
                                htmltemp +=
                                    '<div class="thumbnail lake-form-media-field-item lake-form-media-field-item-op" data-type="' +
                                    list[i]["type"] +
                                    '" data-url="' +
                                    dataUrl +
                                    '" data-id="' +
                        ...
                        var htmltemp =
                            '<div class="col-12"><div class="lake-form-media-empty">' +
                            thiz.lang("empty") +
                            "</div></div>";
                        mediaModalTableCont.append(htmltemp);
                    }

                    mediaModalNavOlCont.html(
                        '<li class="breadcrumb-item lake-form-media-nav-li" data-path="/"><a href="javascript:;"><i class="fa fa-th-large"></i> </a></li>'
                    );
                    mediaModalNavOlCont.data("current-path", "/");
                    for (var i = 0; i < nav.length; i++) {
                        mediaModalNavOlCont.append(
                            '<li class="breadcrumb-item"><a class="lake-form-media-nav-li" href="javascript:;" data-path="' +
                                nav[i]["url"] +
                                '"> ' +
                                nav[i]["name"] +
                                "</a></li>"
                    ...
                    if (totalPage > 1) {
                        if (currentPage > 1) {
                            mediaModalPageCont
                                .find(".lake-form-media-modal-prev-page")
                                .removeClass("hidden");
                        } else {
                            mediaModalPageCont
                                .find(".lake-form-media-modal-prev-page")
                        ...
                        if (currentPage < totalPage) {
                            mediaModalPageCont
                                .find(".lake-form-media-modal-next-page")
                                .removeClass("hidden");
                        } else {
                            mediaModalPageCont
                                .find(".lake-form-media-modal-next-page")
        ...
        refreshInputPreview: function(input) {
            ...
            var imgShowRowCont = mediaCont.find(
                ".lake-form-media-img-show-row"
            );
        ...
        refreshPreview: function(name, urlList, options = []) {
            ...
            if (storeAsId == 1) {
                ...
                for (var i = 0; i < urlList.length; i++) {
                    ...
                    // 创建一个占位符
                    var html =
                        '<div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 lake-form-media-preview-item" data-src="' +
                        materialId +
                        '" data-loading="1">';
                    html += '<div class="thumbnail lake-form-media-row-col">';
                    html +=
                        '<div class="lake-form-media-row-img" title="加载中...">';
                    html +=
                        '<i class="fa fa-spinner fa-spin fa-fw lake-form-media-preview-fa"></i>';
                    html += "</div>";
                    ...
                    if (showicon) {
                        ...
                        html +=
                            '<i class="fa fa-file fa-fw lake-form-media-show-icon" title="loading"></i>';
                        html += "</span>";
                    }
                    ...
                    if (remove) {
                        html +=
                            '<span class="btn btn-default file-delete-multiple lake-form-media-img-show-item-delete" data-url="' +
                            materialId +
                            '" title="' +
                            thiz.lang("remove") +
                    ...
                    if (limit > 1) {
                        html +=
                            '<span class="btn btn-default lake-form-media-img-show-item-dragsort js-dragsort" title="' +
                            thiz.lang("dragsort") +
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                if (res.code == 200 && res.data) {
                                    ...
                                    var materialType =
                                        material.type || requestType; // 使用返回的类型或请求的类型
                                    var materialName =
                                        material.cname || materialId;

                                    // 查找对应的预览项
                                    var previewItem = imgShowRowCont.find(
                                        '.lake-form-media-preview-item[data-src="' +
                                            materialId +
                                            '"]'
                                    );
                                    if (previewItem.length > 0) {
                                        // 更新预览内容
                                        var imgCont = previewItem.find(
                                            ".lake-form-media-row-img"
                                        );
                                        ...
                                        // 更新图标
                                        if (showicon) {
                                            var iconCont = previewItem.find(
                                                ".row-icon"
                                            );
                                            iconCont.html(
                                                thiz.getFileShowType(
                                                    materialUrl,
                                                    materialType
                                                )
                                            );
                                        ...
                                        // 更新标题
                                        if (showtitle) {
                                            var titleCont = previewItem.find(
                                                ".row-title"
                                            );
                                            titleCont.attr(
                                                "title",
                                        ...
                                        // 更新预览按钮
                                        var captionCont = previewItem.find(
                                            ".caption"
                                        );
                                        var suffix = thiz.getFileType(
                                            materialType
                                        );
                                        if (
                                            suffix == "image" ||
                                            ...
                                            var previewBtn =
                                                '<span class="btn btn-default lake-form-media-img-show-item-preview" data-type="' +
                                                suffix +
                                                '" data-url="' +
                                                materialUrl +
                                                '" title="' +
                                    ...
                                    if (previewItem.length > 0) {
                                        ...
                                        imgCont.html(
                                            '<i class="fa fa-exclamation-triangle fa-fw" style="color:red;"></i> 加载失败'
                                        );
                                    }
                                }
                            },
                            error: function(xhr, status, error) {
                                ...
                                if (previewItem.length > 0) {
                                    ...
                                    imgCont.html(
                                        '<i class="fa fa-exclamation-triangle fa-fw" style="color:red;"></i> 请求出错'
                                    );
                                }
                            }
                        });
                ...
                for (var i = 0; i < urlList.length; i++) {
                    ...
                    html +=
                        '<div class="lake-form-media-row-img" title="' +
                        urlList[i] +
                        '">';
                    html += this.getFileDisplay(
                        src,
                        null,
                        null,
                        isCover,
        ...
        getFileDisplay: function(src, type, cover, isCover, videoUrl) {
            ...
            if (fileType === "image") {
                ...
                html +=
                    ...
                    '" alt="' +
                    src +
                    "\" onerror=\"this.onerror=null;this.src='';this.style.display='none';this.parentNode.innerHTML='<i class=\\'fa fa-image fa-fw\\' style=\\'color:#666;\\'></i> 图片加载失败'\"/>";
                ...
                if (cover && cover !== "http://") {
                    ...
                    html +=
                        '<img width="100%" src="' +
                        cover +
                        '" alt="视频封面" data-video-url="' +
                        (videoUrl || src) +
                        "\" onerror=\"this.onerror=null;this.src='';this.style.display='none';this.parentNode.innerHTML='<i class=\\'fa fa-video-camera fa-fw\\' style=\\'color:#666;\\'></i> 视频封面加载失败'\"/>";
                    html +=
                        '<div class="video-play-icon" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: white; font-size: 30px;">';
                    ...
                    html +=
                        ...
                        '" alt="视频封面" data-video-url="' +
                        videoUrl +
                        "\" onerror=\"this.onerror=null;this.src='';this.style.display='none';this.parentNode.innerHTML='<i class=\\'fa fa-video-camera fa-fw\\' style=\\'color:#666;\\'></i> 封面加载失败'\"/>";
                    html +=
                        '<div class="video-play-icon" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: white; font-size: 30px;">';
                    html += '<i class="fa fa-play-circle-o"></i>';
                    html += "</div>";
                    ...
                    html +=
                        '<i class="fa fa-file-video-o fa-fw lake-form-media-preview-fa"></i>';
                }
            } else if (fileType === "audio") {
                html +=
                    '<i class="fa fa-file-audio-o fa-fw lake-form-media-preview-fa"></i>';
            } else if (fileType === "pdf") {
                html +=
                    '<i class="fa fa-file-pdf-o fa-fw lake-form-media-preview-fa"></i>';
            } else if (fileType === "word") {
                html +=
                    '<i class="fa fa-file-word-o fa-fw lake-form-media-preview-fa"></i>';
            } else if (fileType === "ppt") {
                html +=
                    '<i class="fa fa-file-powerpoint-o fa-fw lake-form-media-preview-fa"></i>';
            } else if (fileType === "xls") {
                html +=
                    '<i class="fa fa-file-excel-o fa-fw lake-form-media-preview-fa"></i>';
            } else if (fileType === "text") {
                html +=
                    '<i class="fa fa-file-text-o fa-fw lake-form-media-preview-fa"></i>';
            } else if (fileType === "code") {
                html +=
                    '<i class="fa fa-file-code-o fa-fw lake-form-media-preview-fa"></i>';
            } else if (fileType === "zip") {
                html +=
                    '<i class="fa fa-file-zip-o fa-fw lake-form-media-preview-fa"></i>';
            } else {
                html +=
                    '<i class="fa fa-file fa-fw lake-form-media-preview-fa"></i>';
            }
        ...
        getFileShowType: function(src, type) {
            ...
            if (fileType === "image") {
                html +=
                    '<i class="fa fa-file-image-o fa-fw lake-form-media-show-icon" title="' +
                    fileType +
                    '"></i>';
            } else if (fileType === "video") {
                html +=
                    '<i class="fa fa-file-video-o fa-fw lake-form-media-show-icon" title="' +
                    fileType +
                    '"></i>';
            } else if (fileType === "audio") {
                html +=
                    '<i class="fa fa-file-audio-o fa-fw lake-form-media-show-icon" title="' +
                    fileType +
                    '"></i>';
            } else if (fileType === "pdf") {
                html +=
                    '<i class="fa fa-file-pdf-o fa-fw lake-form-media-show-icon" title="' +
                    fileType +
                    '"></i>';
            } else if (fileType === "word") {
                html +=
                    '<i class="fa fa-file-word-o fa-fw lake-form-media-show-icon" title="' +
                    fileType +
                    '"></i>';
            } else if (fileType === "ppt") {
                html +=
                    '<i class="fa fa-file-powerpoint-o fa-fw lake-form-media-show-icon" title="' +
                    fileType +
                    '"></i>';
            } else if (fileType === "xls") {
                html +=
                    '<i class="fa fa-file-excel-o fa-fw lake-form-media-show-icon" title="' +
                    fileType +
                    '"></i>';
            } else if (fileType === "text") {
                html +=
                    '<i class="fa fa-file-text-o fa-fw lake-form-media-show-icon" title="' +
                    fileType +
                    '"></i>';
            } else if (fileType === "code") {
                html +=
                    '<i class="fa fa-file-code-o fa-fw lake-form-media-show-icon" title="' +
                    fileType +
                    '"></i>';
            } else if (fileType === "zip") {
                html +=
                    '<i class="fa fa-file-zip-o fa-fw lake-form-media-show-icon" title="' +
                    fileType +
                    '"></i>';
            } else {
                html +=
                    '<i class="fa fa-file fa-fw lake-form-media-show-icon" title="' +
                    fileType +
                    '"></i>';
            }
        ...
        lang: function() {
            ...
            if (
                ...
                for (var i = 1; i < arr.length; i++) {
                    current =
                        typeof current[arr[i]] != "undefined"
                            ? current[arr[i]]
                            : "";
        ...
        selectFiles: function(name, files) {
            ...
            if (limit == 1) {
                ...
                if (storeAsId == 1 && idList.length > 0) {
                    ...
                    inputCont.val(id);
                    console.log("Single select (ID value):", id);
                    this.refreshPreview(name, [id], options); // 注意：预览仍需数组格式
                    return;
                } else if (urlList.length > 0) {
                    // 原有单图非storeAsId的处理保持不变
                    if (storeAsId != 1) {
                ...
                if (storeAsId == 1) {
                    ...
                    console.log("Multiple select (ID array):", inputString);
                    inputCont.val(inputString);
                    ...
                    if (urlList.length <= files.length) {
                        ...
                        newList = this.unique(
                            filteredUrlList.slice(-files.length)
                        );
                    }
                }
